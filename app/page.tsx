          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {services.map((service) => (
                ...
                >
                  <div className="mb-4 rounded-lg flex h-12 w-12 items-center justify-center bg-[var(--accent)]/20">
                    <Image
                      src={service.icon}
                      alt=""
                      width={44}
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                <div
                  key={plan.name}
                  className={`relative flex flex-col rounded-xl border p-8 ${plan.featured
                ...
                >
                  ...
                  <a
                    href="#contact"
                    className={`mt-8 block rounded-lg px-4 py-3 text-center font-medium transition-colors ${plan.featured
